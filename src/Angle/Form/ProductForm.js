...
import { Row, Col, Button, FormGroup, Label, ModalFooter, ModalBody} from "reactstrap";
...
import DateRangePicker from "../../components/calender/dateRangePickerOA";
...
class ProductForm extends Component {
    ...
    handleSubmition(values){
        ...
        values.category = values.category ? values.category.category_name : this.state.option.category_name;
