...
import {PROMOCODE_TYPE_1, PROMOCODE_TYPE_2,} from "../../config";
                ...
                >
                    ...
                    <ModalBody>
                        <Row>
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    <Label for="coupon">Usage Limit Per Coupon</Label>
                                    <input
                                        className="form-control"
                                        type="text"
                                        name="coupon"
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    <Label for="limit">Usage Limit Per User</Label>
                                    <input
                                        className="form-control"
                                        type="text"
                                        name="limit"
                            ...
                            <Col md={6}>
                                <FormGroup>
                                    <Label for="type1">Promocode Type</Label>
                                    <Select
                                        ...
                                        options={PROMOCODE_TYPE_1}
                                    />
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    <Label for="type2">Promocode Type</Label>
                                    <Select
                                        classNamePrefix="select"
                                        id="type2"
                                        name="type2"
