...
class ReactSelectCategoryTable extends React.Component {
                           ...
                           <div>
                               {
                                    ...
                                    : <Row>
                                            ...
                                            <Col xs="12" md="3"></Col>
                                            <Col xs="12" md="3">
                                                <button className="btn btn-danger right-float">
...
export default connect(mapStateToProps, mapDispatchToProps)(ReactSelectCategoryTable);