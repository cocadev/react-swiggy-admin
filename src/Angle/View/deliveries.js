...
import {DELIVERIES_COLUMN, DELIVERIES_DATA} from "../../config";
import DeliverySearchForm from "../Form/deliverySearchForm";
            ...
            <Fragment>
                ...
                <Row>
                    <Col sm="12">
                        <Card>
                            <CardBody>
                                <MainCheckBoxTable type={'clients'} data={UtilService.getData(DELIVERIES_DATA)} columns={ DELIVERIES_COLUMN }/>
                            </CardBody>
                        </Card>
                    </Col>
                </Row>
                <Modal isOpen={this.state.modal} toggle={this.toggle} size="lg">
                    <ModalHeader toggle={this.toggle}>Search Delivery</ModalHeader>
                    <DeliverySearchForm />
                </Modal>
            </Fragment>
        );
