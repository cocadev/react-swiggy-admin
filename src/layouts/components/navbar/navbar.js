                  ...
                  <Collapse isOpen={this.state.isOpen} navbar>
                     <Nav className="ml-auto float-right" navbar>
                        <UncontrolledDropdown nav inNavbar className="pr-1">
                           <DropdownToggle nav>
                              <ReactCountryFlag code={code} svg /> {country}
                           </DropdownToggle>
                           <DropdownMenu right>
                              <DropdownItem onClick={() => { this.setState({code:'de', country:'DE'});changeLanguage('de')}} >
                                 <ReactCountryFlag  code="de" svg /> German
                              </DropdownItem>
                              <DropdownItem onClick={() => { this.setState({code:'us', country:'EN'});changeLanguage('en')}} >
                                 <ReactCountryFlag code="us" svg /> English
                              </DropdownItem>
                              <DropdownItem>
                                 <ReactCountryFlag code="tr" svg /> Türkisch
                              </DropdownItem>
                              <DropdownItem>
...
export default withNamespaces('translation')(ThemeNavbar);
